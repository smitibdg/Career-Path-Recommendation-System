#!/usr/bin/env python3
"""
Career Path Recommendation System - Model 1 Scoring Engine  
...
class Model1ScoringEngine:
    ...
    def _get_foundation_questions(self) -> dict:
        """Foundation level questions database - NO UNDERSCORES (MATCHES CSV)"""
        return {
    ...
    def _get_intermediate_questions(self) -> dict:
        ...
        return {
            # ✅ PERSONALITY QUESTIONS (IP001-IP019) - NO UNDERSCORES
            ...
            # ✅ SKILLS QUESTIONS (IS001-IS019) - NO UNDERSCORES
            ...
            # ✅ COGNITIVE QUESTIONS (IC001-IC015) - NO UNDERSCORES
            ...
            # ✅ SITUATIONAL (IT001-IT011) - NO UNDERSCORES
            ...
            # ✅ VALUES (IV001-IV011) - NO UNDERSCORES
